...
class NovaticketCertificateDetail extends StatelessWidget {
  const NovaticketCertificateDetail({super.key, required this.credential});
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    */
                    print('Delete ${credential.referent}');
